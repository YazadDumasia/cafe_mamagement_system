class MenuItem {
  ...
  factory MenuItem.fromJson(Map<String, dynamic> json) {
    final List<dynamic> variationsJson = json['variations'] ?? <dynamic>[];
    final List<MenuItemVariation> variations = variationsJson
  ...
  Map<String, dynamic> toJson() {
    return <String, dynamic>{
      ...
      'isTodayAvailable': isTodayAvailable == true ? 1 : 0,
      'isSimpleVariation': isSimpleVariation == true ? 1 : 0,
      'costPrice': costPrice,
