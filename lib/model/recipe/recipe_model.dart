...
import '../../widgets/azlistview/src/az_common.dart';
...
class RecipeModel extends ISuspensionBean {
  ...
  List<String>? recipeTranslatedIngredientList;
  ...
  factory RecipeModel.fromJson(Map<String, dynamic> json) => RecipeModel(
    ...
    recipeTranslatedIngredientList:
        json["recipe_translated_ingredient_list"] == null
        ? []
        : List<String>.from(
            json["recipe_translated_ingredient_list"]!.map((x) => x),
          ),
    ...
    isBookmark: json['isBookmark'] == null ? false : json['isBookmark'] == 1,
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "recipe_translated_ingredient_list": recipeTranslatedIngredientList == null
        ? []
        : List<dynamic>.from(recipeTranslatedIngredientList!.map((x) => x)),
  ...
  @override
  String toString() {
    return 'RecipeModel{recipeID: $recipeID, id: $id, recipeName: $recipeName, translatedRecipeName: $translatedRecipeName, recipeIngredients: $recipeIngredients, recipeTranslatedIngredients: $recipeTranslatedIngredients, recipeTranslatedIngredientList: $recipeTranslatedIngredientList, recipePreparationTimeInMins: $recipePreparationTimeInMins, recipeCookingTimeInMins: $recipeCookingTimeInMins, recipeTotalTimeInMins: $recipeTotalTimeInMins, recipeServings: $recipeServings, recipeCuisine: $recipeCuisine, recipeCourse: $recipeCourse, recipeDiet: $recipeDiet, recipeInstructions: $recipeInstructions, recipeTranslatedInstructions: $recipeTranslatedInstructions, recipeReferenceUrl: $recipeReferenceUrl, isBookmark: $isBookmark}';
  }
}
